...
set search=%1
set scriptdir=%~dp0
set scriptdir=%scriptdir:windows\=%
...
call %scriptdir%\build\output\bin\Import.exe --typefile %scriptdir%\build\output\share\stylesheets\map.ost --delete-temporary-files true --delete-debugging-files true --delete-analysis-files true --delete-report-files true --destinationDirectory %dir% %arg1%
